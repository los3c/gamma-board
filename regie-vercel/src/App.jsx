...
.rg-app {
  --bg: #1e0034;
  --surface: rgba(40,7,63,.72);
  --surface-2: rgba(50,16,77,.68);
  --surface-3: rgba(60,26,89,.75);
  --border: rgba(148,110,255,.22);
  ...
  background: radial-gradient(ellipse at 20% 10%, #2d0050 0%, #1e0034 50%, #0f001c 100%);
  color: var(--text);
  min-height: 100vh;
  display: flex;
  border-radius: 0;
...
.rg-app[data-theme="light"] {
  ...
  --surface-2: rgba(245,240,252,.82);
  --surface-3: rgba(236,230,248,.85);
  --border: rgba(94,52,158,.16);
  --glass-blur: blur(12px);
  --glass-shine: rgba(255,255,255,.5);
  --text: #1e0034;
  --text-muted: rgba(30,0,52,.62);
  --text-faint: rgba(30,0,52,.38);
  --accent: #b8930a;
...
.rg-sidebar {
  ...
  box-shadow: inset 1px 0 0 var(--glass-shine), 4px 0 24px rgba(0,0,0,.18);
  padding: 22px 16px;
...
.rg-topbar { display: flex; align-items: center; justify-content: space-between; padding: 18px 26px;
  ...
  box-shadow: 0 1px 0 var(--border), inset 0 1px 0 var(--glass-shine); }
...
.rg-panel { background: var(--surface); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur);
  border: 1px solid var(--border); border-radius: 14px; padding: 18px; margin-bottom: 20px;
  box-shadow: 0 4px 20px rgba(0,0,0,.18), inset 0 1px 0 var(--glass-shine); }
...
.rg-kcard { background: var(--surface-2); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur);
  border: 1px solid var(--border); border-left: 3px solid var(--mod-color);
  border-radius: 10px; padding: 11px 12px; margin-bottom: 10px; cursor: pointer;
  box-shadow: 0 2px 12px rgba(0,0,0,.2), inset 0 1px 0 var(--glass-shine);
  transition: transform .12s ease, background .12s ease; }
.rg-kcard:hover { background: var(--surface-3); transform: translateY(-2px); box-shadow: 0 6px 20px rgba(0,0,0,.28), inset 0 1px 0 var(--glass-shine); }
...
.rg-modal { background: var(--surface); backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur);
  border: 1px solid var(--border); border-radius: 16px; width: 100%; max-width: 520px;
  max-height: 88vh; overflow-y: auto; padding: 22px;
  box-shadow: 0 24px 64px rgba(0,0,0,.48), inset 0 1px 0 var(--glass-shine); }
